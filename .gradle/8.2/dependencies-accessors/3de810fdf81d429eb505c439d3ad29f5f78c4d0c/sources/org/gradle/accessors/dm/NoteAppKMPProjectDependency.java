...
@NonNullApi
public class NoteAppKMPProjectDependency extends DelegatingProjectDependency {

    @Inject
    public NoteAppKMPProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
